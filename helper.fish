...
for raw_file in $raw_files
    ...
    # Skip if we have already printed this file
    if contains $file $printed_files
        continue
    end

    # Print the current file if it exists in the root directory
    if test -f $file
        echo "========================================="
        echo " FILE: $file"
        echo "========================================="
    ...
    if string match -q '*.cpp' $file
        ...
        # Print the .hpp file if it exists and hasn't been printed yet
        if test -f $hpp_file
